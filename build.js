...
( async () => {
  ...
  await fsPromises.rename( "dist/random-map-app/osx64", "dist/random-map-app_osx64" );
  await fsPromises.rename( "dist/random-map-app/linux32", "dist/random-map-app_linux32" );
  await fsPromises.rename( "dist/random-map-app/linux64", "dist/random-map-app_linux64" );
  ...
  const buildWindows = async () => {
    ...
    // rename directories to a clearer name for the user
    await fsPromises.rename( "dist/win32", "dist/random-map-app_win32" );
